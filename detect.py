...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        with dt[1]:
            ...
            print("[DEBUG]: logit 0", pred[0].shape)
            print("[DEBUG]: logit 1", pred[1][0].shape, pred[1][1].shape, pred[1][2].shape)
            # print("[DEBUG]: logit 10", pred[1][0][0][0][0][:10])
            # print("[DEBUG]: logit 11", pred[1][1][0][0][0][:10])
            # print("[DEBUG]: logit 12", pred[1][2][0][0][0][:10])
